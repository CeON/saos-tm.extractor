...
(deftest extract-signatures-institutions-test
  (is (= (#'saos-tm.extractor.judgment-links/extract-signatures-osp
  ...
  (is (=
       (#'saos-tm.extractor.judgment-links/extract-signatures-kio-uzp-zo-no-space
  ...
  (is (=
       (#'saos-tm.extractor.judgment-links/extract-signatures-kio-uzp
  ...
  (is (=
       (#'saos-tm.extractor.judgment-links/extract-signatures-kio-uzp-zo
        "UZP/ZO/0-1094/99, UZP/ZO/0-725/05")
      #{"UZP/ZO/0-1094/99" "UZP/ZO/0-725/05"}))
  (is (=
       (#'saos-tm.extractor.judgment-links/extract-signatures-nsa
